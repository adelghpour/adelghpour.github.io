...
(Object.deepExtend = function (e, t) {
   ...
   * http://photoswipe.com
   * Copyright (c) 2019 Dmitry Semenov; */ (function (e, t) {
    "function" == typeof define && define.amd
      ? define(t)
    ...
    return function (e, t, n, i) {
      ...
      var Nt,
        ...
        Vt = function (e) {
          ...
          var isVideo = /\.webm$/i.test(e.src);
          console.log(e.src);
          var t = (e.img = r.createEl("pswp__img", isVideo ? "video" : "img")),
            n = function () {
              (e.loading = !1),
                (e.loaded = !0),
            ...
            if (l) {
              ...
              if (
                ...
                l.src &&
                  !l.loadError &&
                  (((
                    isVideo = /\.webm$/i.test(l.src),
                    i = r.createEl("pswp__img", isVideo ? "Video":"img")).style.opacity = 1),isVideo && (
          i.autoplay = true,
          i.loop = true,
          i.muted = true,
          i.controls = true,
          i.src = l.src // set video src here
        ),
                  (i.src = l.src),
                  Zt(l, i),
                  Gt(0, l, c, i));
                ...
                if (
                  ...
                  d += l.src ? "" : " pswp__img--placeholder--blank";
                  var isVideo = /\.webm$/i.test(l.src);
                  if (isVideo) {
                    var p = r.createEl(d, "video");
                    p.autoplay = true;
                    p.loop = true;
                    p.muted = true;
                    p.controls = true;
                    ...
                    var p = r.createEl(d, "img");
                    p.src = l.src;
                  }

                  Zt(l, p), c.appendChild(p), (l.placeholder = p);
                }
                l.loading || Vt(l),
