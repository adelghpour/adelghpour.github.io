      ...
      var Nt,
        ...
        Vt = function (e) {
          ...
          if (isVideo) {
            ...
            t.muted = true;
            t.controls = true;
            t.addEventListener("loadeddata", n, { once: true });
          }
          return (
            (t.onload = n),
            (t.onerror = function () {
          ...
          setContent: function (e, t) {
            ...
            if (l) {
              ...
              if (
                ...
                if (l.src && !l.loadError) {
                  var isVideo = /\.webm$/i.test(e.src);
                  var i = r.createEl("pswp__img", isVideo ? "video" : "img");
                  i.style.opacity = 1;
                  ...
                  if (isVideo) {
                    ...
                    i.muted = true;
                    i.controls = true;
                    i.addEventListener("loadeddata", n, { once: true });
                  }
                ...
                if (
                  ...
                  if (isVideo) {
                    ...
                    p.muted = true;
                    p.controls = true;
                    p.addEventListener("loadeddata", n, { once: true });
                  }
                  l.msrc && (p.src = l.msrc),
                    Zt(l, p),
                    c.appendChild(p),
